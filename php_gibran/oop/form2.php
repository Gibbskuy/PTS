...
<html lang="en">
  ...
  <div class="form-group">
    <label for="">Tanggal Lahir</label>
    <input type="date" name="tanggal_lahirr" class="form-control" >
  </div>
</div>
...
if(isset($_POST['daftar'])){
    ...
    $tanggal_lahirr = $_POST['tanggal_lahirr'];


class hasil{

    public function pendaftaran($nama_ayah2,$tanggal_lahir2,$nama_ibu2,$tanggal_lahir3){
?>
...
echo $cetak->pendaftaran($nama_ayah,$tanggal_lahir,$nama_ibu,$tanggal_lahirr);
